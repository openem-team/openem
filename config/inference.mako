...
RUN pip3 install --no-cache-dir opencv-python==4.1.1.26 scikit-image==0.14.2 tator>=0.10.8 docker>=4.2.0 tables>=3.6.1 natsort>=7.0.1
RUN echo -e "def find_single_change():\n\tpass" > /usr/local/lib/python3.6/dist-packages/tator/util/find_single_change.py
% elif multiArch.arch == "aarch64":
