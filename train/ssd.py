...
def ssd_model(input_shape, num_classes=21, add_dropout=True):
    """SSD300 architecture.
    ...
    if add_dropout:
        net['dropout3'] = Dropout(0.5, name='dropout3')(net['pool3'])
    else:
        net['dropout3'] = net['pool3']

    # Block 4
    net['conv4_1'] = wrap_with_bn_and_dropout(net,
                                   Convolution2D(512, 3, 3,
                                       activation='linear',
                                       border_mode='same',
                                       name='conv4_1')(net['dropout3']),
                                   name='4_1')
    ...
    net['dropout4'] = Dropout(0.25, name='dropout4')(net['pool4'])

    # Block 5
    net['conv5_1'] = wrap_with_bn_and_dropout(net,
                                              Convolution2D(512, 3, 3,
                                                   activation='linear',
                                                   border_mode='same',
                                                   name='conv5_1')(net['dropout4']),
                                              name='5_1')
    ...
    # FC6
    net['fc6'] = wrap_with_bn_and_dropout(net,
                                          AtrousConvolution2D(1024, 3, 3, atrous_rate=(6, 6),
    ...
    # Block 6
    net['conv6_1'] = wrap_with_bn_and_dropout(
        net,
