...
RUN pip3 install --no-cache-dir opencv-python==4.1.1.26 opencv-contrib-python==4.1.1.26 scikit-image==0.14.2 pytator>=0.1.4 docker>=4.2.0 tables>=3.6.1 natsort>=7.0.1 tator>=0.3.1
% elif multiArch.arch == "aarch64":
